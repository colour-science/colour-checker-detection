"""
Colour Checker Detection - template_colour
=======================================

Defines the template for the colour side of the CALIBRITE COLORCHECKER PASSPORT PHOTO 2
...
name = "colour"
# scale such that swatches are roughly 100x100
width = 810
height = 560
